...
<div class="wrap">
    <div class="wrapper">
        ...
        <%--<a class="a_btn" href="${path}/login">登陆</a>--%>
        <%--</c:if>--%>
        <%--</h1>--%>
        <div class="image_group" style="display: block">
            ...
            <c:forEach items="${requestScope.get(requestScope.get('albums'))}" var="item">
                        ...
                        <div class="image_item" onclick="location.href='${item.getId()}/'">
                            <div class="image">
                                <c:if test="${item.getNumber() eq 0}">
                                    <img lazy="${path}/static/img/no.jpg"
                                         src="${path}/static/img/no.jpg" alt=""
                ...
                <%--<div class="image">--%>
                <%--<img lazy="${path}/common/${item.getCover()}/res?width=400&height=300"--%>
                <%--src="${path}/static/img/loading.jpg" alt=""/>--%>
                <%--<span class="count not_select">${item.getNumber()}</span>--%>
                <%--</div>--%>
                <%--<div class="name">${item.getName()}</div>--%>
...
<script type="text/javascript" src="${path}/static/js/album.js"></script>
