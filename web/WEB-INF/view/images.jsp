...
<head>
    ...
    <!-- <singleLink rel="shortcut icon" href="${path}/static/img/favicon.ico" type="image/x-icon"/> -->
    <link rel="stylesheet" type="text/css" href="${path}/static/css/style.css">
    <link rel="stylesheet" type="text/css" href="${path}/static/css/menu.css">
    <link rel="stylesheet" type="text/css" href="${path}/static/css/manager.css">
    <link rel="stylesheet" type="text/css" href="${path}/static/css/input.css">
    <link rel="stylesheet" type="text/css" href="${path}/static/css/upload.css">
    <style type="text/css">
        .image_item {
            margin: 10px 5px;
...
<div class="wrap">
    <div class="wrapper">
        ...
        <%--&lt;%&ndash;<a class="a_btn" href="${path}/login">登陆</a>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
        <%--</h1>--%>
        ...
        <div class="image_group">
            ...
            <c:forEach var="item" items="${requestScope.get(requestScope.get('quartz'))}">
                ...
                <%--src="${path}/static/img/loading.jpg"--%>
                ...
                <div class="image_item">
                    <div class="image">
                        <img lazy="${path}/common/${requestScope.get(requestScope.get('visitAccount')).getId()}/${requestScope.get(requestScope.get('visitAlbum')).getId()}/${item.getId()}/res?width=400&height=300"
                             layer-src="${path}/common/${requestScope.get(requestScope.get('visitAccount')).getId()}/${requestScope.get(requestScope.get('visitAlbum')).getId()}/${item.getId()}/res"
                             src="${path}/static/img/loading.jpg" alt=""
...
<script type="text/javascript" src="${path}/static/lib/webuploader/0.1.5/webuploader.js"></script>
<script type="text/javascript" src="${path}/static/js/images.js"></script>
