...
<div class="technical-middle">
    <div class="pt-menu-left">
        ...
        <ul id="accordion" class="accordion">
            ...
            <li>
                <div class="link">
                    <a href="../../../WEB-INF/views/prodAndTech/technology.html" target="mainFrame">综合新闻</a>
                </div>
                <ul class="submenu">
            ...
            <li>
                <div class="link">
                    <a href="../../../WEB-INF/views/prodAndTech/technology.html" target="mainFrame">科研动态</a>
                </div>
                <ul class="submenu">
            ...
            <li>
                <div class="link">
                    <a href="../../../WEB-INF/views/prodAndTech/technology.html" target="mainFrame">人才招聘</a>
                </div>
                <ul class="submenu">
    ...
    <iframe class="mainFrame" name="mainFrame" scrolling="no" src="../../../WEB-INF/views/prodAndTech/technology.html" frameborder="0" id="external-frame" onload="this.height=mainFrame.document.body.scrollHeight"></iframe>
