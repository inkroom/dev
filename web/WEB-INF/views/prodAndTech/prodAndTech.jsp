...
<a href="http://www.baidu.com"><img src="../../../resources/img/search2.png" style="height: 6%;z-index: 1;position:absolute;margin-left:90% ;margin-top:2%;float: right"></a>
...
<div class="technical-middle">
    <div class="pt-menu-left">
        ...
        <ul id="accordion" class="accordion">
            ...
            <li>
                <div class="link">
                    <a href="technology.html" target="mainFrame">技术</a>
                </div>
                <ul class="submenu">
                    <li>
                        <a href="#">技术源头</a>
            ...
            <li>
                <div class="link">
                    <a href="product.html" target="mainFrame">产品</a>
                </div>
                <ul class="submenu">
                    <li>
                        <a href="#">无人机载荷系列</a>
                    ...
                    <li>
                        <a href="prod-spectrum.html" target="mainFrame">光谱系列</a>
                    </li>
                    <li>
                        <a href="#">热红外系列</a>
                    </li>
    ...
    <iframe class="mainFrame" name="mainFrame" scrolling="no" src="technology.html" frameborder="0" id="external-frame" onload="this.height=mainFrame.document.body.scrollHeight"></iframe>
