...
<div class="technical-middle">
    <div class="pt-menu-left">
        ...
        <ul id="accordion" class="accordion">
            ...
            <li>
                <div class="link">
                    <a href="../prodAndTech/technology.html" target="mainFrame">硬件</a>
                </div>
                <ul class="submenu">
            ...
            <li>
                <div class="link">
                    <a href="../prodAndTech/technology.html" target="mainFrame">软件</a>
                </div>
                <ul class="submenu">
            ...
            <li>
                <div class="link">
                    <a href="../prodAndTech/technology.html" target="mainFrame">工程</a>
                </div>
                <ul class="submenu">
            ...
            <li>
                <div class="link">
                    <a href="../prodAndTech/technology.html" target="mainFrame">其他</a>
                </div>
                <ul class="submenu">
